...
public:
  explicit EuclideanLossHeatmapLayer(const LayerParameter& param)
    : LossLayer<Dtype>(param), temp1(), temp2(), temp3(), diff_temp(), diff_temp1(), for_diff(), after_img2_all(), after_img3_all(), map2(), map3(){}
...
protected:
 ...
 // Blob<Dtype> diff_;
  //@cf 
  Blob<Dtype> temp1, temp2, temp3, diff_temp, diff_temp1, for_diff, after_img2_all, after_img3_all, map2, map3;
